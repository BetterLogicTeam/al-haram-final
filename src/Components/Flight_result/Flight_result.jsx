    ...
    <>
      <div className="flight_result_main">
        <div className="flight_left">
          <div className="flight_result_swpr">
            <Swiper
              slidesPerView={11}
              spaceBetween={10}
              slidesPerGroup={3}
            ...
            >
              <SwiperSlide>
                <div className="flight_result_text_active ">
                  <span>Aug 1</span> <span className="price">191$</span>
                </div>
              </SwiperSlide>
              <SwiperSlide>
          ...
          <div className="flight_result_sidebar d-flex">
            <div className="side ">
              ...
              <div className="d-flex two">
                <div className="top">
                  <div className="top_first">
                    <h6 className="text-dark">DEPARTURE TIME IN HYDERABAD</h6>
                    <img src={Sunset} alt="" />
              ...
              <div className="d-flex two">
                <div className="top">
                  <div className="top_first">
                    <h6 className="text-dark">ARRIVAL TIME IN MEECA</h6>
                    <img src={Sunset} alt="" />
                    <div className="depart_text">
                      <p>Early Morning</p>
                      <p>00:00 - 04:59</p>
