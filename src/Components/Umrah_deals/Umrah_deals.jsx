        ...
        <div className="container mt-3">
            <div className="row justify-content-center">
                <div className="col-md-2 col-12">
                    <button className='umrah_deal_btn'>umrah packages</button>
                </div>
                <div className="col-md-2 col-12">
                    <button className='umrah_deal_btn'>land packages </button>
                </div>
                <div className="col-md-2 col-12">
                    <button className='umrah_deal_btn'>hajj packages</button>
                </div>
                <div className="col-md-2 col-12">
                    <button className='umrah_deal_btn'>trending packages</button>
                </div>
                <div className="col-md-2 col-12">
                    <button className='umrah_deal_btn'>hotels</button>
                </div>
            </div>
        </div>
...
<button className='choose_btn'>Veiw More</button>
                </div>
