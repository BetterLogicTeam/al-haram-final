    ...
    return <div className="container">
        <div className="row my-3 my-lg-5">
            <div className="col-lg-9 my-3 my-lg-0">
                ...
                <div className="py-3 mb-3" style={{ backgroundColor: "#F5F5F5" }}>
                    <div className="px-3">
                ...
                <div className="py-3 mt-3 " style={{ backgroundColor: "#F5F5F5" }}>
                    <div className="row">
                        ...
                        <div className="col-lg-8" >
                            <div className="row g-0 text-center text-lg-start   ">
                            ...
                            <div className="row mt-2 g-0 text-center text-lg-start">
                            ...
                            <div className="row mt-5 g-0 text-center text-lg-start">
                        ...
                        <div className="col-lg-2 my-auto">
                            <div className="text-center text-lg-start">
                                <button className="px-3 py-2 my-1" style={{ backgroundColor: '#D9D9D9', border: '1px solid #838383' }}>Seat no1 <img src={vertical_bar} alt=''></img></button>
                                <button className="px-3 py-2 ms-2 ms-lg-0 " style={{ backgroundColor: '#D9D9D9', border: '1px solid #838383' }}>Seat no1 <img src={vertical_bar} alt=''></img></button>
...
export default SelectSeatSleeper;
