  ...
  return (
    <div >
      ...
      <Typography className='text-white' variant="h6" style={{ background: "#02A3C1" }} sx={{ flexGrow: 1 }}>
        <div className='text-center pt-1'><h2> Umrah Packages</h2><p className='fs-6 pb-3'>Budget-Friendly & Luxury Package for a  convenient hajj & umrah journeyto the holly <br />
