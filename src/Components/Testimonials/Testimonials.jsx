        ...
        <div className='testimonials_main'>
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-10 card_testimonials">
                <h1 className='Testimonials_main_heading'>What our Travelers are saying</h1>
                        <div className="row  align-items-center">
                            ...
                            <div className="card-body">
                                <div className='d-flex'>
                                    <AiFillStar className='clr_star'></AiFillStar>   <AiFillStar className='clr_star'></AiFillStar>   <AiFillStar className='clr_star'></AiFillStar>   <AiFillStar className='clr_star'></AiFillStar>   <AiFillStar className='clr_star'></AiFillStar>
                                </div>
                            </div>
                        </div> */}
                        </div>
