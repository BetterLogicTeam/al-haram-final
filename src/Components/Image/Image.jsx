...
function Image() {
  ...
  <div class="row ">
    ...
    <div class="col-lg-4 col-sm-12 col-md-6 card ucard ">
        <div className='   px-3 pb-1 pt-4'>   <h6 className='text-white'>Depature City</h6>
...
<div className='   px-3'>   <h6 className='text-white'>Depature Date</h6>
<input type="date" className='p-3 mb-2 w-100  rounded border' />
</div>
<div className='  px-3 pb-3'>   <h6 className='text-white'>Package Category</h6>
...
// className='w-100'
 ...
 <div className="p-3"> <button className='btn btn-outline-light p-3 w-100 mb-2 uHover'><b>Make an Esnquiry</b></button><br/>
 <Link to="/Main_booking"> <button className='btn btn-outline-light p-3 mb-2  w-100 uHover' ><b>Book Now</b></button></Link></div>
